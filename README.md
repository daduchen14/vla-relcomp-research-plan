...
- 当前状态：已完成决策、Day 0—14 教程、免费轻量验证和 H2.5.1 可移植发布入口；尚未租用 GPU、下载模型或运行真实 VLA episode。
...
09—24 号文件保留方向筛选、候选项目、学习负担、新颖性、导师风险、零门槛样例和最终二选一过程；26 号文件保留教程生产任务的历史要求。它们均是证据记录；若与 D1 冲突，以 25 号正式决策为准；若与当前操作路径冲突，以 H2.5.1 fresh-clone 页和教程 README 为准。
